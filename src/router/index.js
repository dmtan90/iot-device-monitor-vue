...
export const asyncRouterMap = [{
  ...
  },
  {
    ...
    children: [{
      path: 'partManager',
      icon: 'fa-users',
      component: _import('admin/partManager/index'),
      name: '园区管理',
      authority: 'partManager'
    },{
      path: 'deviceManager',
      icon: 'fa-users',
      component: _import('admin/deviceManager/index'),
      name: '设备管理',
      authority: 'deviceManager'
    }, {
      path: 'parentManage',
      icon: 'fa-users',
      component: _import('admin/parentManage/index'),
      name: '人员管理',
      authority: 'parentManage'
    }]
  }];
