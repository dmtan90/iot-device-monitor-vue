<template>
    <div class="app-container calendar-list-container">
      ...
      <el-row>
        ...
        <el-col :span="19" style='margin-top:15px;padding-left: 20px;'>
          <el-card class="box-card">
          ...
          <el-card class="box-card" style="margin-top: 15px;">
            <span>按钮或资源</span>
            <iot-menus-elements :menuId='currentId' ref="menuElement"></iot-menus-elements>
          </el-card>
        </el-col>
      </el-row>
      </el-card>
...
<script>
  ...
  export default {
    name: 'menu',
    components: {
      'iot-menus-elements': () => import('./components/element')
    },
    data() {
      return {
        filterText: '',
