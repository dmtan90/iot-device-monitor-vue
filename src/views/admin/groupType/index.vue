  ...
  <div class="app-container calendar-list-container">
    <el-card class="box-card">
      ...
      <el-table :key='tableKey'
                ...
                style="width: 100%">
        <el-table-column type="index" fixed prop="id" label="ID" align="center" width="150">
        ...
        <el-table-column align="center" sortable prop="code" label="编码">
          <template slot-scope="scope">
            <span>{{scope.row.code}}</span>
          </template>
        </el-table-column>

        <el-table-column align="center" sortable prop="name" label="类型名称">
          <template slot-scope="scope">
            <span>{{scope.row.name}}</span>
          </template>
        </el-table-column>

        <el-table-column align="center" sortable prop="description" label="描述">
          <template slot-scope="scope">
            <span>{{scope.row.description}}</span>
          </template>
        </el-table-column>

        <el-table-column align="center" sortable prop="updTime" label="最后更新时间">
          <template slot-scope="scope">
        ...
        <el-table-column align="center" sortable prop="updHost" label="最后更新主机">
          <template slot-scope="scope">
