<template>
  <el-row>
    <el-col :span="24">
      <el-button-group>
        ...
        <el-button type="primary" v-if="groupManager_btn_resourceManager" @click="handlerAuthority">
          <icon-svg icon-class="quanxian1"></icon-svg>
          权限分配
        </el-button>
    ...
    <el-dialog class="user-dialog" :title="dialogUserName" :visible.sync="dialogUserVisible">
      <group-user :groupId="currentId" @closeUserDialog="closeUserDialog" ref="groupUser"></group-user>
    </el-dialog>
    <el-dialog class="authority-dialog" :title="dialogAuthorityName" :visible.sync="dialogAuthorityVisible">
