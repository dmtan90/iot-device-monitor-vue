...
<div class="app-container calendar-list-container">
  ...
  <div class="filter-container">
    <el-row type="flex" class="row-bg" justify="end">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px; margin-right: 10px" class="filter-item"
                placeholder="姓名/账户/手机号" clearable v-model="listQuery.name"></el-input>
    ...
    <el-table :key='tableKey'
              ...
              :default-sort="{prop: 'updTime', order: 'descending'}"
              style="width: 100%">
      <el-table-column type="index" fixed prop="id" align="center" label="序号" width="150">
      ...
      <el-table-column align="center" sortable prop="username" label="账户">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" sortable prop="sex" label="性别">
        <template slot-scope="scope">
          ...
          <el-table-column align="center" sortable prop="description" label="手机">
        <template slot-scope="scope">
            <span>{{scope.row.mobilePhone}}</span>
          </template> </el-table-column>
      <el-table-column align="center" sortable prop="description" label="备注">
        <template slot-scope="scope">
            <span>{{scope.row.description}}</span>
          </template> </el-table-column>
      <el-table-column align="center" sortable prop="updTime" label="最后时间">
        <template slot-scope="scope">
          <span>{{scope.row['updTime']}}</span>
        </template> </el-table-column>
      <el-table-column align="center" sortable prop="updName" label="最后更新人">
        <template slot-scope="scope">
