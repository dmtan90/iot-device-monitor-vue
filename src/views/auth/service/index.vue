<template>
  <div class="app-container calendar-list-container">
    <el-card class="box-card">
      ...
      <el-dialog class="text-dialog" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-dialog class="service-client-dialog" :title="dialogClientName" :visible.sync="dialogClientVisible">
...
<style>
  .service-client-dialog > .el-dialog{
    width: 360px;
  }
